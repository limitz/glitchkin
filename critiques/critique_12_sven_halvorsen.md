...
## Procedural Draw Library — `LTG_TOOL_procedural_draw.py`
...
Environment `LTG_ENV_other_side_bg.png` generated by `LTG_TOOL_bg_other_side.py`. No warm colours present at the environment level per the spec. The UV Purple and Cyan lighting language is consistent with SF03. Consistent.
