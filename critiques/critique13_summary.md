...
3. **luma.md proportion contradiction** (Reinhardt) — luma.md still says 3.5 heads; character_sheet_standards.md says 3.2. A new artist cannot resolve this. Fix: update luma.md.
