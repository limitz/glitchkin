...
Jordan Reed is rebuilding SF03 v003 to correct Byte's body fill from Void Black (10,10,20) to GL-01b (#00D4E8 / RGB 0,212,232). The v002 generator (`LTG_TOOL_style_frame_03_other_side_v002.py`) had `BYTE_BODY = (10, 10, 20)`, making Byte essentially invisible against the dark platform background — a figure-ground failure.
