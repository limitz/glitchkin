...
Style Frame 02 — "Glitch Storm" — Critique C10 Fix Pass
"Luma & the Glitchkin"

Artist: Sam Kowalski | Cycle 22
Based on: LTG_TOOL_style_frame_02_glitch_storm_v004.py (Jordan Reed, Cycle 19)

Cycle 22 fixes (Critique C10 feedback):
  1. WINDOW PANE ALPHA — Reduced from 160/180 to 115/110 (consensus 110-120 range).
     Victoria: panes at 160-180 read as bright signage, not embedded windows.
     Naomi: windows at 160-180 are more saturated than Luma's storm-modified hoodie,
     inverting character-warmth hierarchy. Windows support the narrative; they
     do not compete with the protagonist.
     Glow cones (max alpha ~105) are NOT changed — already correct.
  2. CORRUPT_AMBER corrected to GL-07 canonical value #FF8C00 (255, 140, 0).
     v004 used (200, 122, 32) = #C87A20 — murky brownish amber that loses contrast
     against cyan-dominant storm. GL-07 #FF8C00 is the genuine warm-cold complement
     to Electric Cyan #00F0FF. The color story's claim that Byte's outline is
     "load-bearing" only holds with the high-contrast version.

# TODO: update import to LTG_TOOL_render_lib_v001 after Kai's rename

Output: /home/wipkat/team/output/color/style_frames/LTG_COLOR_styleframe_glitch_storm_v005.png
Usage: python3 LTG_TOOL_style_frame_02_glitch_storm_v005.py
"""
...
OUTPUT_PATH = "/home/wipkat/team/output/color/style_frames/LTG_COLOR_styleframe_glitch_storm_v005.png"
W, H = 1920, 1080
...
CORRUPT_AMBER   = (255, 140,   0)   # GL-07 canonical #FF8C00 — C22 fix: was (200,122,32)=#C87A20
                                    # #FF8C00 is the genuine warm-cold complement to Electric Cyan
                                    # #C87A20 is murky amber that loses contrast in cyan-dominant storm
...
def _draw_building_windows_with_glow(img, buildings, horizon_y):
    ...
    """
    # C22 fix: reduced from (SOFT_GOLD, 180) / (WARM_CREAM, 160) to 115/110.
    # At 160-180 the panes were more saturated-visible than Luma's storm hoodie,
    # inverting character-warmth hierarchy. At 110-120 they read as luminous
    # embedded windows, not competing signage. Glow cones (~105 max) unchanged.
...
def main():
    print("LTG_TOOL_style_frame_02_glitch_storm_v005.py")
    print("Rendering Style Frame 02 — Glitch Storm (Critique C10 Fix Pass)...")
    print("  C22 Fixes: (1) CORRUPT_AMBER corrected to GL-07 #FF8C00 (255,140,0),")
    print("             (2) Window pane alpha reduced to 115/110 (from 180/160)")
    ...
    print("\nFix verification (Critique C10 / C22):")
    print("  [FIX C22-1] CORRUPT_AMBER = (255,140,0) = #FF8C00 GL-07 canonical ✓")
    print("  [FIX C22-2] Window pane alpha: SOFT_GOLD=115, WARM_CREAM=110 (was 180/160) ✓")
