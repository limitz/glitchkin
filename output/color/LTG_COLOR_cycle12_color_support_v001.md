...
| SF02 Glitch Storm Color Key PNG | None — all colors documented in SF02 spec + master palette | Generated: LTG_COLOR_colorkey_glitchstorm_v001.png |
...
|---|---|---|
| `LTG_COLOR_colorkey_glitchstorm_v001.png` | `/output/color/color_keys/thumbnails/` | SF02 rendered color key (Priority 3) |
| `LTG_TOOL_colorkey_glitchstorm_gen_v001.py` | `/output/tools/` | Generator script for above |
| `LTG_TOOL_naming_compliance_copy_v001.py` | `/output/tools/` | Creates LTG-compliant named copies |
| `LTG_COL_luma_colormodel_v001.png` | `/output/characters/color_models/swatches/` | LTG-compliant copy |
| `LTG_COL_byte_colormodel_v001.png` | `/output/characters/color_models/swatches/` | LTG-compliant copy |
| `LTG_COL_cosmo_colormodel_v001.png` | `/output/characters/color_models/swatches/` | LTG-compliant copy |
| `LTG_COL_miri_colormodel_v001.png` | `/output/characters/color_models/swatches/` | LTG-compliant copy |
| `LTG_COLOR_colorkey_sunny_afternoon_v001.png` | `/output/color/color_keys/thumbnails/` | LTG-compliant copy |
| `LTG_COLOR_colorkey_nighttime_glitch_v001.png` | `/output/color/color_keys/thumbnails/` | LTG-compliant copy |
| `LTG_COLOR_colorkey_glitchlayer_entry_v001.png` | `/output/color/color_keys/thumbnails/` | LTG-compliant copy |
| `LTG_COLOR_colorkey_quiet_moment_v001.png` | `/output/color/color_keys/thumbnails/` | LTG-compliant copy |
| `LTG_COLOR_cycle12_color_support_v001.md` (this file) | `/output/color/` | Color support notes |
