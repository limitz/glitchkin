...
- `output/backgrounds/environments/` — LTG_ENV_tech_den_v004 + _styled, LTG_ENV_grandma_kitchen_v003 + _styled
- `output/tools/LTG_TOOL_stylize_handdrawn_v001.py`
- `output/tools/LTG_TOOL_render_lib_v001.py`
- `output/production/stylization_preset_handdrawn_v001.md`
...
### Tech Den (LTG_ENV_tech_den_v004, _styled)
...
### Kitchen (LTG_ENV_grandma_kitchen_v003, _styled)
