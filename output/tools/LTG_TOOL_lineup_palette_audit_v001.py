#!/usr/bin/env python3
"""
LTG_TOOL_lineup_palette_audit_v001.py
...
Usage:
    python3 LTG_TOOL_lineup_palette_audit_v001.py [lineup.png] [--tolerance N]

Defaults:
    lineup.png  : output/characters/main/LTG_CHAR_character_lineup_v007.png
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        default=os.path.join(
            ...
            "../characters/main/LTG_CHAR_character_lineup_v007.png",
        ),
        help="Path to the lineup PNG (default: LTG_CHAR_character_lineup_v007.png)",
    )
    parser.add_argument(
        "--tolerance",
        type=float,
