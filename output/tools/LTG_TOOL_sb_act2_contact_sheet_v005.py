#!/usr/bin/env python3
"""
LTG_TOOL_sb_act2_contact_sheet_v005.py
Act 2 Contact Sheet v005 — Cycle 19
Lee Tanaka, Storyboard Artist

Changes from v004:
  - Adds A2-07b (Bridging shot — Miri hears something — NEW)
  - Uses A2-08 v002 (MCU Luma POV camera fix)
  - Total: 12 panels
  - Layout: 3-row, 4/4/4 panels per row
  - Version string: v005 / Cycle 19
...
Panel sequence (arc order):
  ...
  A2-07b — BRIDGE (Miri hears something — NEW)
...
Output:
  /home/wipkat/team/output/storyboards/act2/LTG_SB_act2_contact_sheet_v005.png
"""
...
OUTPUT_PATH = os.path.join(ACT2_DIR, "LTG_SB_act2_contact_sheet_v005.png")
...
PANEL_SEQUENCE = [
    ...
    (PANELS_DIR + "/LTG_SB_act2_panel_a207b_v001.png",
     "A2-07b\nbridge",      "BRIDGE",       (160, 140, 80)),     # NEW
    (PANELS_DIR + "/LTG_SB_act2_panel_a208_v002.png",
     "A2-08\nrecognition",  "RECOGNITION",  (200, 180, 240)),    # v002
]
...
def generate():
    ...
    sd.text((sheet_w - 155, 6), "v005 — Cycle 19",
    ...
    sd.text((MARGIN, footer_y),
            "v005 | Cycle 19 | 12 panels | A2-07b NEW (bridge) | A2-08 v002 (Luma POV camera fix)",
...
if __name__ == "__main__":
    generate()
    print("Act 2 contact sheet v005 generation complete (Cycle 19).")
