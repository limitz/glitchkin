...
ACT2_DIR = output_dir('storyboards', 'act2')
...
PANEL_SEQUENCE = [
    ...
    (str(PANELS_DIR) + "/LTG_SB_act2_panel_a201.png",
     "A2-01\nestablishing", "ESTABLISHED",             (200, 180, 120)),
    (ACT2_PANELS + "/LTG_SB_act2_panel_a202.png",
     "A2-02\nByte MCU v2",  "VULNERABLE (RESIGNED-55%)", (0, 200, 220)),
    (str(PANELS_DIR) + "/LTG_SB_act2_panel_a203.png",
     "A2-03\nskeptic v2",   "SKEPTICAL",               (220, 160, 40)),
    (str(PANELS_DIR) + "/LTG_SB_act2_panel_a204.png",
     "A2-04\nmontage v2",   "INVESTIGATING",            (120, 200, 120)),
    (str(PANELS_DIR) + "/LTG_SB_act2_panel_a205.png",
     "A2-05\nwalk+talk",    "WALK+TALK",               (220, 200, 100)),
    (str(PANELS_DIR) + "/LTG_SB_act2_panel_a205b.png",
     "A2-05b\napp setup",   "DETERMINED",              (180, 220, 80)),
    (str(PANELS_DIR) + "/LTG_SB_act2_panel_a206_med.png",
     "A2-06 MED\nhopeful",  "HOPEFUL",                 (240, 220, 100)),
    (str(PANELS_DIR) + "/LTG_SB_act2_panel_a206.png",
     "A2-06\nfailure",      "FAILURE",                 (220, 60, 60)),
    (str(PANELS_DIR) + "/LTG_SB_act2_panel_a207.png",
     "A2-07\nresigned",     "RESIGNED",                (80, 140, 200)),
    (str(PANELS_DIR) + "/LTG_SB_act2_panel_a207b.png",
     "A2-07b\nbridge",      "BRIDGE",                  (160, 140, 80)),
    (str(PANELS_DIR) + "/LTG_SB_act2_panel_a208.png",
