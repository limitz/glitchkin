# LTG_TOOL_expression_silhouette_v001 — Test Results

**Author:** Maya Santos — Cycle 33
**Date:** 2026-03-29
**Tool:** `output/tools/LTG_TOOL_expression_silhouette_v001.py`
...
|---|---|---|---|---|---|
| `LTG_CHAR_luma_expressions_v008.png` | 3×3 | 7/9 | FAIL | P1↔P2 | 91.0% |
| `LTG_CHAR_glitch_expression_sheet_v003.png` | 3×3 | 5/9 | **PASS** | P0↔P1 | 71.1% |
| `LTG_CHAR_grandma_miri_expression_sheet_v002.png` | 3×3 | 9/9 | FAIL | P1↔P2 | 93.6% |
| `LTG_CHAR_cosmo_expression_sheet_v003.png` | 3×3 | 9/9 | FAIL | P1↔P2 | 95.9% |
| `LTG_CHAR_byte_expression_sheet_v003.png` | 3×3 | 9/9 | FAIL | P7↔P8 | 88.8% |
...
```
python3 output/tools/LTG_TOOL_expression_silhouette_v001.py <sheet.png> [options]
...
Contact sheet: `LTG_TOOL_expression_silhouette_v001_test_luma_v008.png`
