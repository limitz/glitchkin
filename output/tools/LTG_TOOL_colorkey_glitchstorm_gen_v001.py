#!/usr/bin/env python3
"""
LTG_TOOL_colorkey_glitchstorm_gen_v001.py
...
Output: /home/wipkat/team/output/color/color_keys/thumbnails/
        LTG_COLOR_colorkey_glitchstorm_v001.png
        (Also generates LTG-compliant copy of the existing key thumbnails for compliance)

Usage: python3 LTG_TOOL_colorkey_glitchstorm_gen_v001.py
"""
...
def generate_sf02_glitch_storm_colorkey():
    ...
    out_path = os.path.join(OUTPUT_DIR, "LTG_COLOR_colorkey_glitchstorm_v001.png")
    img.save(out_path)
