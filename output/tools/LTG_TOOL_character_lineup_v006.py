#!/usr/bin/env python3
"""
LTG_TOOL_character_lineup_v006.py
...
Cycle 29 changes (Maya Santos, Character Designer):
  ...
  - Output: LTG_CHAR_luma_lineup_v006.png (never overwrites v005).
...
Output: /home/wipkat/team/output/characters/main/LTG_CHAR_luma_lineup_v006.png
Usage: python3 LTG_TOOL_character_lineup_v006.py
"""
...
def generate_lineup(output_path):
    ...
    title = "LUMA & THE GLITCHKIN — Full Cast Height Lineup — Cycle 29 (Luma v007 style: 3.2 heads)"
    ...
    footer = (
        ...
        "Colors per master_palette.md (canonical). Cycle 29 — Luma updated to v007 style (3.2 heads, eye h\u00d70.22)."
    )
...
def main():
    ...
    generate_lineup(os.path.join(out_dir, "LTG_CHAR_luma_lineup_v006.png"))
    print("Character lineup v006 generation complete.")
