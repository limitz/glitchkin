#!/usr/bin/env python3
"""
LTG_TOOL_grandma_miri_expression_sheet_v004.py
...
Output: output/characters/main/LTG_CHAR_grandma_miri_expression_sheet_v004.png
"""
...
if __name__ == "__main__":
    ...
    out_path = os.path.join(out_dir, "LTG_CHAR_grandma_miri_expression_sheet_v004.png")
    sheet    = build_sheet()
    sheet.save(out_path)
