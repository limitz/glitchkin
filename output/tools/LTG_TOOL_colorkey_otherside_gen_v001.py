#!/usr/bin/env python3
"""
LTG_TOOL_colorkey_otherside_gen_v001.py
...
Output: /home/wipkat/team/output/color/color_keys/thumbnails/
        LTG_COLOR_colorkey_otherside_v001.png

Usage: python3 LTG_TOOL_colorkey_otherside_gen_v001.py
...
def main():
    ...
    out_path = os.path.join(OUTPUT_DIR, "LTG_COLOR_colorkey_otherside_v001.png")
    img.save(out_path)
