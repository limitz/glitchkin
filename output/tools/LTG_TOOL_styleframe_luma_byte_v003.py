#!/usr/bin/env python3
"""
LTG_TOOL_styleframe_luma_byte_v003.py
Style Frame 04 "The Dynamic" — Luma + Byte Interaction v003
"Luma & the Glitchkin" — Cycle 28 / Rin Yamamoto

C32 STUB FIX (Kai Nakamura):
  Original: LTG_COLOR_styleframe_luma_byte_v003.py (deleted by C29 naming cleanup)
  The original generator code is not recoverable. The output PNG is preserved at:
    output/color/style_frames/LTG_COLOR_styleframe_luma_byte_v003.png
  ...
  Per pitch_package_index.md: SF04 v003 is the current pitch primary (C28 — Rin Yamamoto).
  This is the canonical active version of SF04.
...
def generate(output_path=None):
    """
    Preservation stub: re-saves the existing v003 output PNG.
    The original generator was deleted by C29 cleanup; artwork is preserved.
    This is the current pitch primary SF04.
    """
    ...
    draw.text((W // 2 - 200, H // 2 - 40),
              "SF04 — Luma + Byte Dynamic v003 (PITCH PRIMARY)",
