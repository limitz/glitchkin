#!/usr/bin/env python3
"""
LTG_TOOL_sb_act1_full_contact_sheet_v001.py
...
Note on naming:
  A1-04 (kitchen) = LTG_SB_act1_panel_a104_v001.png  (cold open last beat)
  A1-04 (classroom) = LTG_SB_act2_panel_a104_v001.png (separate near-miss beat,
    previously shown in Act 2 contact sheet as the A2-sequence setup panel)

Output:
  /home/wipkat/team/output/storyboards/LTG_SB_act1_full_contact_sheet_v001.png
"""
...
OUTPUT_PATH = os.path.join(OUTPUT_DIR, "LTG_SB_act1_full_contact_sheet_v001.png")
