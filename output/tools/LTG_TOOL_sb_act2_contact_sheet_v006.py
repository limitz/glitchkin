#!/usr/bin/env python3
"""
LTG_TOOL_sb_act2_contact_sheet_v006.py
Act 2 Contact Sheet v006 — Cycle 20
Lee Tanaka, Storyboard Artist

Changes from v005:
  - A2-02 updated to LTG_SB_act2_panel_a202_v002.png (Maya Santos Cycle 18 rebuild)
...
Output:
  /home/wipkat/team/output/storyboards/act2/LTG_SB_act2_contact_sheet_v006.png
"""
...
OUTPUT_PATH = os.path.join(ACT2_DIR, "LTG_SB_act2_contact_sheet_v006.png")
...
PANEL_SEQUENCE = [
    ...
    (ACT2_PANELS + "/LTG_SB_act2_panel_a202_v002.png",
