"""
LTG_TOOL_luma_cold_overlay_swatches_v001.py
...
def generate():
    ...
    # Footer
    draw.text((MARGIN_LEFT, H - 30), "LTG_TOOL_luma_cold_overlay_swatches_v001.py  ·  Sam Kowalski, Color & Style Artist  ·  Cycle 18  ·  Luma & the Glitchkin", fill=(100, 90, 80), font=font_small)

    # ── Save ──────────────────────────────────────────────────────────────
    out_path = "/home/wipkat/team/output/characters/color_models/swatches/LTG_COLOR_luma_cold_overlay_v001.png"
