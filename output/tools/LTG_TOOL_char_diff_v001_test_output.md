# LTG_TOOL_char_diff_v001 — Test Output
...
```
REF : output/characters/main/LTG_CHAR_luma_expressions_v007.png  (1200x900)
CAND: output/characters/main/LTG_CHAR_luma_expression_sheet_v006.png  (1200x900)
```
...
```
REF : LTG_CHAR_luma_expressions_v007.png — panel 1 (CURIOUS)
CAND: LTG_CHAR_luma_expression_sheet_v006.png — panel 1 (CURIOUS)
...
```
REF : output/characters/main/turnarounds/LTG_CHAR_luma_turnaround_v003.png
CAND: output/characters/main/turnarounds/LTG_CHAR_luma_turnaround_v002.png
