#!/usr/bin/env python3
"""
LTG_SB_pilot_cold_open_v002.py
...
Output: LTG_SB_pilot_cold_open_v002.png
...
OUTPUT_PATH = os.path.join(OUTPUT_DIR, "LTG_SB_pilot_cold_open_v002.png")
...
def make_contact_sheet():
    ...
    draw.text((MARGIN, footer_y),
              "LTG_SB_pilot_cold_open_v002  |  output/storyboards/  |  ≤1280px  |  C38 fixes",
...
if __name__ == "__main__":
    make_contact_sheet()
    print("LTG_SB_pilot_cold_open_v002 generation complete (Cycle 38).")
    print("Fixes applied:")
