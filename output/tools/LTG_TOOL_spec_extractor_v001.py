#!/usr/bin/env python3
"""
LTG_TOOL_spec_extractor_v001.py
...
Usage (standalone)
-------------------
    python LTG_TOOL_spec_extractor_v001.py luma
    python LTG_TOOL_spec_extractor_v001.py cosmo --json
    python LTG_TOOL_spec_extractor_v001.py --all
    python LTG_TOOL_spec_extractor_v001.py --all --save-dir output/specs/

API
----
    from LTG_TOOL_spec_extractor_v001 import extract_spec, extract_all, format_spec_report
