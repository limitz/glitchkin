...
Usage:
  python3 LTG_TOOL_char_diff_v001.py reference.png candidate.png [x y w h]
...
def parse_args(argv: list) -> tuple:
    ...
    if len(argv) < 3:
        print("Usage: python3 LTG_TOOL_char_diff_v001.py reference.png candidate.png [x y w h]")
        sys.exit(1)
    ref_path = argv[1]
    cand_path = argv[2]
    bbox = None
