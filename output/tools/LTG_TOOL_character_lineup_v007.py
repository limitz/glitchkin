#!/usr/bin/env python3
"""
LTG_TOOL_character_lineup_v007.py
...
Cycle 33 changes (Alex Chen, Art Director):
  ...
  - Output: LTG_CHAR_character_lineup_v007.png (never overwrites v006).
...
def main():
    ...
    generate_lineup(os.path.join(out_dir, "LTG_CHAR_character_lineup_v007.png"))
