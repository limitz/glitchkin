...
Purpose:
  ...
  Files addressed in Cycle 12 (color/ and characters/color_models/ scope):
    ...
    color/color_keys/thumbnails/key01_sunny_afternoon.png
      → LTG_COLOR_colorkey_sunny_afternoon_v001.png
    color/color_keys/thumbnails/key02_nighttime_glitch.png
      → LTG_COLOR_colorkey_nighttime_glitch_v001.png
    color/color_keys/thumbnails/key03_glitch_layer_entry.png
      → LTG_COLOR_colorkey_glitchlayer_entry_v001.png
    color/color_keys/thumbnails/key04_quiet_moment.png
      → LTG_COLOR_colorkey_quiet_moment_v001.png
    color/style_frames/style_frame_01_rendered.png
      → LTG_COLOR_styleframe_discovery_v001.png
    characters/color_models/swatches/luma_swatches.png
      → LTG_COL_luma_colormodel_v001.png   (per Priority 2 naming format)
...
Usage: python3 LTG_TOOL_naming_compliance_copy_v001.py
"""
...
COPY_MAP = [
    ...
    (
        ...
        f"{BASE}/color/color_keys/thumbnails/LTG_COLOR_colorkey_sunny_afternoon_v001.png"
    ),
    (
        f"{BASE}/color/color_keys/thumbnails/key02_nighttime_glitch.png",
        f"{BASE}/color/color_keys/thumbnails/LTG_COLOR_colorkey_nighttime_glitch_v001.png"
    ),
    (
        f"{BASE}/color/color_keys/thumbnails/key03_glitch_layer_entry.png",
        f"{BASE}/color/color_keys/thumbnails/LTG_COLOR_colorkey_glitchlayer_entry_v001.png"
    ),
    (
        f"{BASE}/color/color_keys/thumbnails/key04_quiet_moment.png",
        f"{BASE}/color/color_keys/thumbnails/LTG_COLOR_colorkey_quiet_moment_v001.png"
    ),
    ...
    (
        ...
        f"{BASE}/characters/color_models/swatches/LTG_COL_luma_colormodel_v001.png"
    ),
    (
        f"{BASE}/characters/color_models/swatches/byte_swatches.png",
        f"{BASE}/characters/color_models/swatches/LTG_COL_byte_colormodel_v001.png"
    ),
    (
        f"{BASE}/characters/color_models/swatches/cosmo_swatches.png",
        f"{BASE}/characters/color_models/swatches/LTG_COL_cosmo_colormodel_v001.png"
    ),
    (
        f"{BASE}/characters/color_models/swatches/grandma_miri_swatches.png",
        f"{BASE}/characters/color_models/swatches/LTG_COL_miri_colormodel_v001.png"
    ),
]
