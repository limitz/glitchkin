#!/usr/bin/env python3
"""
test_face_lighting_v001.py — Test harness for add_face_lighting()
Generates: output/tools/test_face_lighting_v001.png  (≤ 640px)
...
Run:
    python output/tools/test_face_lighting_v001.py
"""
import math
import os
import sys
...
if __name__ == "__main__":
    ...
    _out = os.path.join(_here, "test_face_lighting_v001.png")
