...
Output: output/characters/color_models/LTG_COLOR_glitch_color_model_v001.png

[Renamed from LTG_CHAR_glitch_color_model_v001.py to LTG_TOOL_glitch_color_model_v001.py
...
def main():
    ...
    out_path = os.path.join(out_dir, "LTG_COLOR_glitch_color_model_v001.png")
    model.save(out_path)
