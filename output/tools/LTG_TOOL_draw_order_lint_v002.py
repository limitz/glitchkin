#!/usr/bin/env python3
"""
LTG_TOOL_draw_order_lint_v002.py
...
Usage (standalone):
    ...
    python LTG_TOOL_draw_order_lint_v002.py --compare

API:
    from LTG_TOOL_draw_order_lint_v002 import lint_file, lint_directory, format_report
...
def compare_v1_v2(directory, pattern="LTG_TOOL_*.py"):
    ...
    try:
        ...
        import LTG_TOOL_draw_order_lint_v001 as v1_mod
    except ImportError:
        return "ERROR: Could not import LTG_TOOL_draw_order_lint_v001 — ensure it is in the tools directory."
...
if __name__ == "__main__":
    ...
    report_path = args.save_report or os.path.join(
        here, "LTG_TOOL_draw_order_lint_v002_report.txt"
    )
    try:
