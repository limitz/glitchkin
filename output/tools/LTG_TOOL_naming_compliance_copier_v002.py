...
- glitch_layer_layout.png  → LTG_ENV_glitchlayer_layout_v001.png
- frame01_house_interior.png → LTG_ENV_lumashome_study_interior_v002.png
  (v001 already exists as LTG_ENV_lumashome_study_interior_v001.png — same source, different name origin)
...
COMPLIANCE_COPIES = [
    ...
    (
        ...
        f"{BASE}/backgrounds/environments/layouts/LTG_ENV_glitchlayer_layout_v001.png",
    ),
    # ── ENV BACKGROUNDS ───────────────────────────────────────────────────────
    # frame01_house_interior.png — LTG_ENV_lumashome_study_interior_v001.png
    ...
    (
        ...
        f"{BASE}/backgrounds/environments/LTG_ENV_glitchlayer_encounter_v001.png",
    ),
    (
        f"{BASE}/backgrounds/environments/glitch_layer_frame.png",
        f"{BASE}/backgrounds/environments/LTG_ENV_glitchlayer_frame_v002.png",
    ),
]
