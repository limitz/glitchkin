...
Generates: output/characters/color_models/LTG_COLOR_grandma_miri_color_model_v001.png
...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "LTG_COLOR_grandma_miri_color_model_v001.png")
...
def draw_swatch_sheet():
    ...
    draw.text((MARGIN_LEFT, y + 8), "Source: grandma_miri_color_model.md v1.0 + master_palette.md v2.0 | LTG_COLOR_grandma_miri_color_model_v001.png", font=font_rgb, fill=SUBTITLE_COLOR)
