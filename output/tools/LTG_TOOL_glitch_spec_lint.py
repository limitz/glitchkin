...
Usage
-----
    python LTG_TOOL_glitch_spec_lint.py [file_or_directory]
    python LTG_TOOL_glitch_spec_lint.py output/tools/LTG_TOOL_glitch_expression_sheet.py

API
---
    from LTG_TOOL_glitch_spec_lint import lint_file, lint_directory, format_report
