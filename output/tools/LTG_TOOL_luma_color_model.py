...
Output: output/characters/color_models/LTG_COLOR_luma_color_model.png
"""
...
def main():
    ...
    out_path = os.path.join(out_dir, "LTG_COLOR_luma_color_model.png")
    model.save(out_path)
