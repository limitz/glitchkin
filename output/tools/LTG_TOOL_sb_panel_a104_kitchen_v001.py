#!/usr/bin/env python3
"""
LTG_TOOL_sb_panel_a104_kitchen_v001.py
Storyboard Panel A1-04 (kitchen cold open) — FIRST CONTACT — Byte appears — Cycle 18
Lee Tanaka, Storyboard Artist

NOTE: A1-04 (classroom near-miss) already exists as LTG_SB_act2_panel_a104_v001.png.
...
OUTPUT_PATH = os.path.join(PANELS_DIR, "LTG_SB_act1_panel_a104_v001.png")
