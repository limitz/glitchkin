#!/usr/bin/env python3
"""
LTG_TOOL_bg_tech_den_v004.py — Cosmo's Tech Den Background v004 (Daylight)
...
def draw_tech_den():
    ...
    # ── OUTPUT ────────────────────────────────────────────────────────────────
    out_path = "/home/wipkat/team/output/backgrounds/environments/LTG_ENV_tech_den_v004.png"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="LTG_TOOL_bg_tech_den_v004 — Cosmo's Tech Den")
    parser.add_argument(
        "--check-warmth",
        action="store_true",
