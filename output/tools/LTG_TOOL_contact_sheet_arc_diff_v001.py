#!/usr/bin/env python3
"""
LTG_TOOL_contact_sheet_arc_diff_v001.py
...
Usage:
  python3 LTG_TOOL_contact_sheet_arc_diff_v001.py OLD.png NEW.png [OUTPUT.png]
...
def main() -> None:
    if len(sys.argv) < 3:
        print("Usage: LTG_TOOL_contact_sheet_arc_diff_v001.py OLD.png NEW.png [OUTPUT.png]",
              file=sys.stderr)
        sys.exit(1)
