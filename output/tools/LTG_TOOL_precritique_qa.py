...
def build_report(
    ...
    lines = [
        ...
        "",
        f"**Run date:** {run_ts}",
        f"**Script:** LTG_TOOL_precritique_qa.py v2.10.0",
        "",
        "---",
        "",
        "## Overall Result",
    ...
    lines.append("---")
    lines.append("")
    lines.append("*Generated by LTG_TOOL_precritique_qa.py v2.10.0 — Rin Yamamoto (C43: CYCLE_LABEL=C43, SF04 FILL_LIGHT_ASSETS path fix, --save-nolight enabled)*")
