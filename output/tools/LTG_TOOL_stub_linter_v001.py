...
Usage:
    python LTG_TOOL_stub_linter_v001.py [directory]
    python LTG_TOOL_stub_linter_v001.py --pre-commit

API:
    from LTG_TOOL_stub_linter_v001 import lint_directory, format_report
