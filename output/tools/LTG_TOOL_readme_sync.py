...
Usage:
    python LTG_TOOL_readme_sync.py [--save-report PATH]
    python LTG_TOOL_readme_sync.py --json
...
def format_report(audit_result: dict) -> str:
    ...
    lines = [
        f"# README Script Index Audit — LTG_TOOL_readme_sync.py v{__version__}",
        "",
    ...
    lines.append("---")
    lines.append(f"*Generated by LTG_TOOL_readme_sync.py v{__version__} — Morgan Walsh, Pipeline Automation*")
