...
Output: output/characters/color_models/LTG_COLOR_byte_color_model.png

[Renamed from LTG_COLOR_byte_color_model_v001.py to LTG_TOOL_byte_color_model.py
...
def main():
    ...
    out_path = os.path.join(out_dir, "LTG_COLOR_byte_color_model.png")
    model.save(out_path)
