...
Usage:
    python LTG_TOOL_naming_cleanup_v001.py [--dry-run]
...
CLEANUP_MAP = [
    ...
    ("LTG_CHAR_luma_expression_sheet_v002.py",            "LTG_TOOL_luma_expression_sheet_v002.py"),
    ("LTG_CHAR_luma_expression_sheet_v003.py",            "LTG_TOOL_luma_expression_sheet_v003.py"),
    ("LTG_CHAR_luma_expression_sheet_v004.py",            "LTG_TOOL_luma_expression_sheet_v004.py"),
    ("LTG_CHAR_luma_expression_sheet_v005.py",            "LTG_TOOL_luma_expression_sheet_v005.py"),
    ("LTG_CHAR_luma_expression_sheet_v006.py",            "LTG_TOOL_luma_expression_sheet_v006.py"),
    ("LTG_CHAR_luma_turnaround_v002.py",                  "LTG_TOOL_luma_turnaround_v002.py"),
    ...
    ("LTG_CHAR_cosmo_turnaround_v002.py",                 "LTG_TOOL_cosmo_turnaround_v002.py"),
    ("LTG_CHAR_grandma_miri_expression_sheet_v003.py",    "LTG_TOOL_grandma_miri_expression_sheet_v003.py"),
    # LTG_CHAR_ -> LTG_TOOL_ (glitch generators)
    ("LTG_CHAR_glitch_expression_sheet_v001.py",          "LTG_TOOL_glitch_expression_sheet_v001.py"),
    ("LTG_CHAR_glitch_expression_sheet_v002.py",          "LTG_TOOL_glitch_expression_sheet_v002.py"),
    ("LTG_CHAR_glitch_turnaround_v001.py",                "LTG_TOOL_glitch_turnaround_v001.py"),
    ("LTG_CHAR_glitch_turnaround_v002.py",                "LTG_TOOL_glitch_turnaround_v002.py"),
    ("LTG_CHAR_glitch_color_model_v001.py",               "LTG_TOOL_glitch_color_model_v001.py"),
    # LTG_COLOR_ -> LTG_TOOL_ (color models)
    ("LTG_COLOR_luma_color_model_v001.py",                "LTG_TOOL_luma_color_model_v001.py"),
    ("LTG_COLOR_byte_color_model_v001.py",                "LTG_TOOL_byte_color_model_v001.py"),
    ("LTG_COLOR_cosmo_color_model_v001.py",               "LTG_TOOL_cosmo_color_model_v001.py"),
    # LTG_COLOR_ -> LTG_TOOL_ (style frames)
    ("LTG_COLOR_styleframe_luma_byte_v001.py",            "LTG_TOOL_styleframe_luma_byte_v001.py"),
    ("LTG_COLOR_styleframe_luma_byte_v002.py",            "LTG_TOOL_styleframe_luma_byte_v002.py"),
    ("LTG_COLOR_styleframe_luma_byte_v003.py",            "LTG_TOOL_styleframe_luma_byte_v003.py"),
    # LTG_BRAND_ -> LTG_TOOL_ (logo generators)
    ("LTG_BRAND_logo_v001.py",                            "LTG_TOOL_logo_v001.py"),
]
