...
Replaces: LTG_ENV_other_side_bg_v001.png (Cycle 14 pre-spec version used grid floor approach)
Output:   LTG_ENV_other_side_bg_v002.png
...
if __name__ == "__main__":
    out_path = "/home/wipkat/team/output/backgrounds/environments/LTG_ENV_other_side_bg_v002.png"
    generate(out_path)
