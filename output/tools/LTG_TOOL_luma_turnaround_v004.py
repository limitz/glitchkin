#!/usr/bin/env python3
"""
LTG_TOOL_luma_turnaround_v004.py
...
Output: output/characters/main/turnarounds/LTG_CHAR_luma_turnaround_v004.png
"""
...
def main():
    ...
    out_path = os.path.join(out_dir, "LTG_CHAR_luma_turnaround_v004.png")
    img.save(out_path)
