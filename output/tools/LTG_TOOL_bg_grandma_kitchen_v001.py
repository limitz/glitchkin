#!/usr/bin/env python3
"""
LTG_TOOL_bg_grandma_kitchen_v001.py — Grandma Miri's Kitchen Background
...
Environment spec:
  ...
  - No Glitch colors (no ELEC_CYAN, ACID_GREEN, DATA_BLUE, UV_PURPLE, HOT_MAGENTA)
    Exception: CRT TV glow through doorway ONLY (faint, far-plane)
...
Output: /home/wipkat/team/output/backgrounds/environments/LTG_ENV_grandma_kitchen_v001.png
"""
...
def draw_doorway_and_crt(img, draw, bw_left, bw_top, bw_bot):
    ...
    # CRT TV light spill on adjacent room floor — faint cool tint
...
def main():
    ...
    print("LTG_TOOL_bg_grandma_kitchen_v001.py")
    print("Rendering Grandma Miri's Kitchen — A1-01 (Act 1 opening)...")
    ...
    print("  [4] Doorway + CRT TV in adjacent room (story element)...")
    ...
    print("  [10] Morning light pass (window shaft, warm ambient)...")
    img = draw_morning_light(img, win_x1, win_x2, win_y1, win_y2, bw_bot)
    draw = ImageDraw.Draw(img)

    print("  [11] Final warm morning atmosphere pass...")
    img = draw_morning_light_pass(img, win_x1, win_x2, bw_bot)

    out_path = "/home/wipkat/team/output/backgrounds/environments/LTG_ENV_grandma_kitchen_v001.png"
    ...
    print("  - CRT TV through doorway (story element — faint glow) ✓")
