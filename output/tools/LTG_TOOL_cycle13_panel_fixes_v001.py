...
Outputs:
  ...
  - Updated contact_sheet.png + LTG_SB_coldopen_contactsheet_v002.png
...
def main():
    ...
    shutil.copy(os.path.join(PANELS_DIR, "panel_p13_scream.png"),
                os.path.join(PANELS_DIR, "LTG_SB_coldopen_panel_13_v002.png"))
    print("  [COPY] LTG_SB_coldopen_panel_13_v002.png")
    ...
    shutil.copy(os.path.join(PANELS_DIR, "panel_p15_luma_freefall.png"),
                os.path.join(PANELS_DIR, "LTG_SB_coldopen_panel_15_v002.png"))
    print("  [COPY] LTG_SB_coldopen_panel_15_v002.png")
    ...
    shutil.copy(os.path.join(PANELS_DIR, "panel_p03_first_pixel.png"),
                os.path.join(PANELS_DIR, "LTG_SB_coldopen_panel_03_v002.png"))
    print("  [COPY] LTG_SB_coldopen_panel_03_v002.png")
    ...
    shutil.copy(os.path.join(PANELS_DIR, "panel_p08_byte_real_world.png"),
                os.path.join(PANELS_DIR, "LTG_SB_coldopen_panel_08_v002.png"))
    print("  [COPY] LTG_SB_coldopen_panel_08_v002.png")
    ...
    shutil.copy(os.path.join(PANELS_DIR, "panel_p09_byte_sees_luma.png"),
                os.path.join(PANELS_DIR, "LTG_SB_coldopen_panel_09_v002.png"))
    print("  [COPY] LTG_SB_coldopen_panel_09_v002.png")
    ...
    shutil.copy(cs_path, os.path.join(PANELS_DIR, "LTG_SB_coldopen_contactsheet_v002.png"))
    print("  [COPY] LTG_SB_coldopen_contactsheet_v002.png")
