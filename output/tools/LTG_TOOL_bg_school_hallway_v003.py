#!/usr/bin/env python3
"""
LTG_TOOL_bg_school_hallway_v003.py — Millbrook School Hallway Background v003
...
Output: /home/wipkat/team/output/backgrounds/environments/LTG_ENV_school_hallway_v003.png
"""
...
def draw_school_hallway():
    ...
    # ── OUTPUT ────────────────────────────────────────────────────────────────
    out_path = "/home/wipkat/team/output/backgrounds/environments/LTG_ENV_school_hallway_v003.png"
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="LTG_TOOL_bg_school_hallway_v003 — Millbrook School Hallway")
    parser.add_argument(
        "--check-warmth",
        action="store_true",
