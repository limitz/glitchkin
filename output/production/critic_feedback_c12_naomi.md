...
- `/home/wipkat/team/output/color/style_frames/LTG_COLOR_styleframe_glitch_storm_v001.png` — SF02 rendered background
- `/home/wipkat/team/output/color/color_keys/thumbnails/LTG_COLOR_colorkey_glitchstorm_v001.png` — Glitch Storm color key
- `/home/wipkat/team/output/color/LTG_COLOR_cycle12_color_support_v001.md` — Sam's color support document
- `/home/wipkat/team/output/color/style_frames/LTG_COLOR_styleframe_discovery_v002.png` — SF01 v002 with ghost Byte
- `/home/wipkat/team/output/tools/LTG_TOOL_colorkey_glitchstorm_gen_v001.py` — Color key generator script
- `/home/wipkat/team/output/tools/LTG_TOOL_style_frame_02_glitch_storm_v001.py` — SF02 background generator script
- `/home/wipkat/team/output/style_guide.md` — Color rule compliance reference
- `/home/wipkat/team/output/production/critic_feedback_c10_naomi.md` — My Cycle 10 report (outstanding items reference)
...
I read every confetti color list in both `LTG_TOOL_colorkey_glitchstorm_gen_v001.py` and `LTG_TOOL_style_frame_02_glitch_storm_v001.py` against master palette Forbidden Rule #8.
