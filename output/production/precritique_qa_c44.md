# Pre-Critique QA Report — C44

**Run date:** 2026-03-30 08:28
...
*Generated by LTG_TOOL_precritique_qa.py v2.11.0 — Ryo Hasegawa (C44: CYCLE_LABEL=C44; MOTION_SHEETS extended: cosmo+miri added, luma panel count 3→4; Rin Yamamoto (C43: SF04 FILL_LIGHT_ASSETS path fix, --save-nolight enabled))*