...
The master palette lists GL-07 Corrupted Amber as `#FF8C00` (255, 140, 0). This is correct in the master palette. However, the actual SF02 v004 generator (`LTG_TOOL_style_frame_02_glitch_storm_v004.py`, line 51) defines:
...
**File:** `output/tools/LTG_TOOL_style_frame_02_glitch_storm_v004.py`
