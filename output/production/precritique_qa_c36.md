# Pre-Critique QA Report — C36

**Run date:** 2026-03-29 21:30
...
| Stub Linter (tools dir)        | PASS   | 153   | 0   | 0   |
| Palette Warmth Lint            | PASS| 11| 0| 0|
| Glitch Spec Lint               | WARN | 3 | 26 | 0 |
| README Script Index Sync       | PASS | 151 | 0 | 0 |

---

## 0. Delta Report

**Delta since last run (C35 @ 2026-03-29 20:43): +0 FAIL, +1 WARN, -0 resolved**

_Compared against: C35 run @ 2026-03-29 20:43_
...
Target files:
  ...
  - `LTG_COLOR_styleframe_glitch_storm_v006.png` (found)
...
**Flagged items:**
  ...
  - LTG_COLOR_styleframe_glitch_storm_v006.png / warm_cool: WARN — Flat palette — warm/cool separation is 6.5 PIL units (minimum 20.0 required)
...
PASS: 153  WARN: 0  FAIL: 0  Missing: 0
...
PASS: 3  WARN: 26  FAIL: 0  Missing: 0


_(Non-Glitch files: 124 skipped)_
...
PASS: 151  WARN: 0  FAIL: 0  Missing: 0


_(Tools on disk: 151  |  Tools listed in README: 186)_
...
*Generated by LTG_TOOL_precritique_qa_v001.py v2.1.0 — Morgan Walsh, Pipeline Automation*