...
6. **Naming convention violations** — `LTG_CHAR_luma_motion_v001.py`, `LTG_CHAR_byte_motion_v001.py`, `LTG_SB_pilot_cold_open_v001.py` live in `output/tools/` with non-TOOL prefixes. → Kai + Diego + Ryo C38
