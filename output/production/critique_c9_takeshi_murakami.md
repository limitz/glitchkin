...
## 1. Tech Den — `LTG_ENV_tech_den_v001.png` [C+]
...
## 2. School Hallway — `LTG_ENV_school_hallway_v001.png` [B−]
...
## 3. Millbrook Main Street — `LTG_ENV_millbrook_main_street_v001.png` [B]
...
## 4. Grandma Miri's Kitchen — `LTG_ENV_grandma_kitchen_v001.png` [B+] (Context Review)
