...
**File:** `LTG_CHAR_cosmo_turnaround_v002.png`
...
**Generator:** `LTG_CHAR_luma_expression_sheet_v002.py`, `draw_neutral_resting()` and `draw_at_rest_curiosity()`
