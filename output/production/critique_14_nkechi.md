...
`LTG_TOOL_precritique_qa_v001.py` baseline: **WARN** (PASS=152, WARN=37, FAIL=0).
...
### `LTG_CHAR_luma_expressions_v009.png` — Luma Expression Sheet
...
### `LTG_COLOR_styleframe_glitch_storm_v006.png` — SF02 Glitch Storm (C34 Character Lighting Pass)
