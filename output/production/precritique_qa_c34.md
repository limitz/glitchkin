...
**Script:** LTG_TOOL_precritique_qa.py v1.0.0
...
**Flagged items:**
  ...
  - LTG_TOOL_glitch_color_model.py: G001: ry=56 is outside spec range [24–46] (spec ref: 34)
  ...
  - LTG_TOOL_glitch_expression_sheet.py: G002: Body mass ratio FAIL — ry=34 must be > rx=40 (diamond must be taller than wide)
  - LTG_TOOL_glitch_expression_sheet.py: G002: Body mass ratio FAIL — ry=34 must be > rx=40 (diamond must be taller than wide)
  - LTG_TOOL_glitch_expression_sheet.py: G002: Body mass ratio FAIL — ry=34 must be > rx=40 (diamond must be taller than wide)
  - LTG_TOOL_glitch_spec_lint.py: G002: Body mass ratio FAIL — ry=34 must be > rx=38 (diamond must be taller than wide)
  - LTG_TOOL_glitch_turnaround.py: G002: Body mass ratio FAIL — ry=38 must be > rx=42 (diamond must be taller than wide)
...
*Generated by LTG_TOOL_precritique_qa.py — Morgan Walsh, Pipeline Automation*