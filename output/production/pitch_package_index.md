...
| Grandma Miri color model v001 (visual) | `/home/wipkat/team/output/characters/color_models/LTG_COLOR_grandma_miri_color_model_v001.png` | 23-swatch visual color model for Grandma Miri — full palette rendered as an inspectable PNG reference (Cycle 17 — Maya Santos / Sam Kowalski) | Accepted (Cycle 17 — new) | None |
...
10. ~~**Act 2 panels (A2-07, Byte cracked-eye ECU)**~~ — **RESOLVED Cycle 16.** `LTG_SB_act2_panel_a207_v002.png` delivered. ECU + full RESIGNED expression. Contact sheet v003 (8 panels). Cycle 17: A2-01, A2-05, A2-08 added — contact sheet v004 (11 panels, full arc).
11. ~~**Expression sheet for Grandma Miri**~~ — **RESOLVED Cycle 17.** `LTG_CHAR_grandma_miri_expression_sheet_v001.png` — 5 expressions. C17 Gap 1 closed.
12. ~~**Line weight undifferentiation in expression sheets**~~ — **RESOLVED Cycle 17.** `LTG_CHAR_luma_expression_sheet_v002.png` with explicit 3-tier line weight. C17 Gap 2 addressed.
...
| Classroom BG v002 | `/home/wipkat/team/output/backgrounds/environments/LTG_ENV_classroom_bg_v002.png` | Unified dual-source lighting (warm window left / cool fluorescent right, clean crossover ~40-50%). Inhabitant evidence added (wear marks, scattered worksheets, backpack, chalk dust). |
| Grandma Miri's Kitchen | `/home/wipkat/team/output/backgrounds/environments/LTG_ENV_grandma_kitchen_v001.png` | New A1-01 opening background. Cozy morning kitchen. Pre-digital appliances, morning light, lived-in details. CRT TV through doorway. Zero Glitch palette. |
| A2-07 — Byte RESIGNED ECU | `/home/wipkat/team/output/storyboards/act2/panels/LTG_SB_act2_panel_a207_v002.png` | Placeholder replaced. ECU on cracked eye + RESIGNED expression. 7×7 dead-pixel glyph at ~30% frame width. Hot Magenta crack. Arms drawn in. Most important Act 2 beat, now real. |
| A2-03 — Cosmo SKEPTICAL (restage) | `/home/wipkat/team/output/storyboards/act2/panels/LTG_SB_act2_panel_a203_v002.png` | Full restage with camera spec. Two-point perspective. Whiteboard as visual character ("Doomed Plan v4.7" — color-coded, crossed-out step 5). Cosmo FG-left, Luma BG-right. |
| A2-06 MED — Hopeful two-shot | `/home/wipkat/team/output/storyboards/act2/panels/LTG_SB_act2_panel_a206_med_v001.png` | New panel preceding A2-06 INSERT. Cosmo+Luma hopeful two-shot before phone failure. Screen glow on both faces. Explicitly links to INSERT. Carmen's missing establishing shot, now delivered. |
| A2-04 montage v002 | `/home/wipkat/team/output/storyboards/act2/panels/LTG_SB_act2_panel_a204_v002.png` | Byte added as visible non-participant (back turned, floating in TR corner). Camera angle variety across 4 quadrants. |
| Act 2 contact sheet v003 | `/home/wipkat/team/output/storyboards/act2/LTG_SB_act2_contact_sheet_v003.png` | 8 panels. Arc: NEAR-MISS → VULNERABLE → SKEPTICAL → INVESTIGATING → DETERMINED → HOPEFUL → FAILURE → RESIGNED. Colored arc-label borders. |
| SF02 generator v003 | `/home/wipkat/team/output/tools/LTG_TOOL_style_frame_02_glitch_storm_v003.py` | DRW-07 corrected to #C8695A. Takeshi critique fixes. ENV-06 verified correct from v002. |
| SF03 generator v002 | `/home/wipkat/team/output/tools/LTG_TOOL_style_frame_03_other_side_v002.py` | Takeshi + Naomi critique fixes implemented. |

### Cycle 17 Additions

| Asset | File Path | Notes |
|---|---|---|
| Luma expression sheet v002 (refined) | `/home/wipkat/team/output/characters/main/LTG_CHAR_luma_expression_sheet_v002.png` | 6-expression sheet with construction guides, 3-tier line weight (8/4/10px silhouette/interior/brow), 2x LANCZOS render. 6 expressions: CURIOUS, DETERMINED, SURPRISED, WORRIED, DELIGHTED, FRUSTRATED. Construction guides visible via RGBA overlay. Replaces previous v002 (Cycle 12 4×2 sheet). |
| Grandma Miri expression sheet v001 | `/home/wipkat/team/output/characters/main/LTG_CHAR_grandma_miri_expression_sheet_v001.png` | First-ever Miri expression sheet. 5 expressions: WARM/WELCOMING, NOSTALGIC/WISTFUL, CONCERNED, SURPRISED/DELIGHTED, WISE/KNOWING. 88% circular head, round glasses, crow's feet always present. Blush absent in CONCERNED per spec. Closes C17 Gap 1 (CRITICAL). |
| Grandma Miri color model v001 | `/home/wipkat/team/output/characters/color_models/LTG_COLOR_grandma_miri_color_model_v001.png` | 23-swatch visual color model for Grandma Miri. Visual companion to `grandma_miri_color_model.md`. |
| Tech Den — Cosmo's workspace | `/home/wipkat/team/output/backgrounds/environments/LTG_ENV_tech_den_v001.png` | Act 2 key environment. Cosmo's bedroom-repurposed-as-workspace. Dual CRT monitors, oscilloscope, breadboards, shelving with vintage PCs + cartridges, circuit diagrams, warm daylight + monitor glow. Cosmo's dusty lavender jacket on chair. Real World palette only. 1280×720. |
| Millbrook School Hallway | `/home/wipkat/team/output/backgrounds/environments/LTG_ENV_school_hallway_v001.png` | Millbrook Middle interior. 3-point perspective, low camera. Metal lockers (sage/lavender alternating), linoleum checkerboard floor, fluorescent ceiling grid, bulletin boards, trophy case, "MILLBROOK MIDDLE" banner, daylit T-intersection far end. Atmospheric cool haze on distant end. Real World palette only. 1280×720. |
...
| Act 2 contact sheet v004 | `/home/wipkat/team/output/storyboards/act2/LTG_SB_act2_contact_sheet_v004.png` | 11 panels / 3-row layout (4/4/3). Adds A2-01, A2-05, A2-08. Full arc complete: NEAR-MISS → ESTABLISHED → VULNERABLE → SKEPTICAL → INVESTIGATING → WALK+TALK → DETERMINED → HOPEFUL → FAILURE → RESIGNED → RECOGNITION. |
| A2-01 — Tech Den wide (Act 2 opener) | `/home/wipkat/team/output/storyboards/act2/panels/LTG_SB_act2_panel_a201_v001.png` | WIDE / slightly high-angle. Two-point perspective room. Cosmo BG at desk, FOCUSED. Luma FG-left in doorway, DETERMINED. Scale difference labeled. |
...
| Asset | File Path | Notes |
|---|---|---|
| SF02 Glitch Storm v007 | `/home/wipkat/team/output/color/style_frames/LTG_COLOR_styleframe_glitch_storm_v007.png` | **PITCH PRIMARY for SF02.** Implements `_draw_luma_face_sprint()`: asymmetric eyes (left r≈6px leading, right r≈4px focused), forward-offset pupils, corrugator brow differential, jaw-set horizontal mouth. Torso lean 10° forward (sprint body committed to motion). Hair stream redrawn more horizontal (velocity read) + trailing strand. `get_char_bbox()` misuse fixed: Luma cx hardcoded to int(W×0.45). Fill-light direction corrected: upper-right toward storm crack (per Jordan Reed module). 1280×720. Generator: `output/tools/LTG_TOOL_style_frame_02_glitch_storm_v007.py`. (Cycle 35 — Rin Yamamoto) |
| Cosmo expression sheet v005 | `/home/wipkat/team/output/characters/main/LTG_CHAR_cosmo_expression_sheet_v005.png` | Silhouette differentiation pass. AWKWARD (new): max asymmetry, defensive palm-out gesture, shoulder raise, pigeon-toe. WORRIED (redesigned): wide-W head-grab bracket, body hunch. SURPRISED (redesigned): near-horizontal bilateral arm extension 1.30×HU, backward lean, blush. Labels moved outside panel bounds. 3×2 grid, 1182×1114px. Silhouette FAIL (IoM metric bias for standing human characters — systematic limitation, documented). Generator: `output/tools/LTG_TOOL_cosmo_expression_sheet_v005.py`. (Cycle 35 — Maya Santos) |
| Miri expression sheet v004 | `/home/wipkat/team/output/characters/main/LTG_CHAR_grandma_miri_expression_sheet_v004.png` | Silhouette differentiation pass. WARM/WELCOMING: wide-open arms swept up to shoulder height. NOSTALGIC/WISTFUL: chest-flat right hand on sternum. CONCERNED: clasped-center hands (prayer/worry). SURPRISED/DELIGHTED: hand-to-cheek gesture (asymmetric, grandmother "oh my"). WISE/KNOWING: relaxed crossed arms. KNOWING STILLNESS: index-point-down (one small asymmetric element). 3×2 grid, 1200×900px. Same IoM tool limitation as Cosmo v005 (documented). Generator: `output/tools/LTG_TOOL_grandma_miri_expression_sheet_v004.py`. (Cycle 35 — Maya Santos) |
| Glitch expression sheet v003 (G002 fix) | `/home/wipkat/team/output/characters/main/LTG_CHAR_glitch_expression_sheet_v003.png` | **Geometry corrected.** All generators fixed: rx=34, ry=38 (diamond taller than wide — matches glitch.md spec ry>rx). Previous rx=38, ry=34 was wider-than-tall — spec contradiction 34 cycles old. Generators fixed: v001, v002, v003 expression sheets + v001, v002 turnarounds + v001 color model. Spec doc glitch.md §2.1 + §10 corrected. Glitch_spec_lint_v001 → v1.1.0 (RX/RY corrected, range widened). (Cycle 35 — Kai Nakamura) |
| Kitchen environment v004 | `/home/wipkat/team/output/backgrounds/environments/LTG_ENV_grandma_kitchen_v004.png` | **Chiara C14 rebuild.** Value floor: DEEP_COCOA/NEAR_BLACK_WARM applied in ceiling corners, cabinet undersides, floor corners, table underside (min now 20 vs 62). Warm/cool separation: top/bottom temperature split — SUNLIT_AMBER warm at top (alpha 55), CRT_COOL_SPILL=(0,130,148) at bottom (alpha 90). QA warm/cool: 32.95 (threshold 20, PASS). Spatial coherence: Miri-specific details — rose-pattern earthenware mug, knitting bag, worn floral apron, travel-destination fridge magnets (5 countries), supplement bottles, handwritten wall calendar. 1280×720. Generator: `output/tools/LTG_TOOL_bg_grandma_kitchen_v004.py`. (Cycle 35 — Jordan Reed) |
...
| Warmth lint v003 | `/home/wipkat/team/output/tools/LTG_TOOL_palette_warmth_lint_v003.py` | Soft-tolerance mode: `soft_tolerance: {"G": 0, "B": 10}`. Allows warm-adjacent entries where B may slightly exceed R. Default: strict. New `--strict` CLI flag. (Cycle 35 — Sam Kowalski) |
...
| README sync tool | `/home/wipkat/team/output/tools/LTG_TOOL_readme_sync_v001.py` | Enumerates LTG_TOOL_*.py on disk vs README Script Index. Reports UNLISTED / GHOST / LEGACY GHOST. Integrated as Section 7 of precritique_qa. 35+6 previously-unlisted tools now registered. (Cycle 35 — Morgan Walsh) |
| Render QA v1.3.0 | `/home/wipkat/team/output/tools/LTG_TOOL_render_qa_v001.py` | Check F (value ceiling guard). Detects specular hotspot loss during thumbnail downscale. Reports brightness_before/after/loss, specular_candidate (bool), specular_count. (Cycle 35 — Morgan Walsh) |
| Pre-critique QA v2.0.0 | `/home/wipkat/team/output/tools/LTG_TOOL_precritique_qa_v001.py` | Section 7 (README Sync) integrated. All 7 sections now run in one command. (Cycle 35 — Morgan Walsh) |
| Character face test tool | `/home/wipkat/team/output/tools/LTG_TOOL_character_face_test_v001.py` | Renders character head at configurable sprint scale (head_r 10–60px). 6 expression variants. 3× zoomed reference crop. Output contact sheet ≤600×400px. Validates minimum readability threshold at production scale. Luma r=23 PASS confirmed. (Cycle 35 — Lee Tanaka) |
| Spec extractor tool | `/home/wipkat/team/output/tools/LTG_TOOL_spec_extractor_v001.py` | Parses character .md files (Luma, Cosmo, Miri, Byte, Glitch): head_ratio, eye_coeff, hex colors, degree constants, line weights, element counts. Output: JSON-serializable Python dict. Foundation for future spec-sync CI gate. (Cycle 35 — Kai Nakamura) |
| Glitch spec lint v1.1.0 | `/home/wipkat/team/output/tools/LTG_TOOL_glitch_spec_lint_v001.py` | RX_SPEC/RY_SPEC corrected to 34/38. G001 range widened for larger-scale renders. All 3 expression sheet generators now PASS G002. (Cycle 35 — Kai Nakamura) |
...
| Spec sync CI gate | `/home/wipkat/team/output/tools/LTG_TOOL_spec_sync_ci_v001.py` | CI gate for all 5 characters. P1 violations fail CI. C36 baseline: **Cosmo S003 P1 FAIL** (glasses_tilt 10° vs 7° spec). All others PASS/WARN. (Cycle 36 — Kai Nakamura) |
| Expression silhouette v003 (RPD) | `/home/wipkat/team/output/tools/LTG_TOOL_expression_silhouette_v003.py` | **New metric: Regional Pose Delta (RPD).** 3-zone weighted Pearson correlation: HEAD 35%, ARMS 45%, LEGS 20%. Fixes IoM bias for standing human characters. WARN ≥70%, FAIL ≥85%. (Cycle 36 — Maya Santos) |
| Warmth lint v004 | `/home/wipkat/team/output/tools/LTG_TOOL_palette_warmth_lint_v004.py` | Per-world warm/cool threshold inference from filename. `infer_world_type()` maps filename patterns to REAL/OTHER_SIDE/GLITCH. Advisory WARN only. All v003 features retained. (Cycle 36 — Kai Nakamura) |
...
| Asset | File Path | Notes |
|---|---|---|
| Grandma's Kitchen v005 | `/home/wipkat/team/output/backgrounds/environments/LTG_ENV_grandma_kitchen_v005.png` | **Dual-Miri visual plant.** Handwritten "MIRI" fridge label: cream paper scrap (40×16px) at (906–946, 461–477) on lower fridge door, warm brown ink (LINE_DARK), amber magnet pip above. First-watch invisible — reads as domestic label at thumbnail scale; legible at full res. Single change over v004. QA: value range PASS, warm/cool sep ≥20 PASS. Generator: `output/tools/LTG_TOOL_bg_grandma_kitchen_v005.py`. (Cycle 39 — Jordan Reed) |
| Cold Open Storyboard v003 | `/home/wipkat/team/output/storyboards/LTG_SB_pilot_cold_open_v003.png` | **P01/P12/P13 staging complete.** P01 = NEW WIDE EXTERIOR NIGHT panel (residential street, Luma's house lit upstairs window — establishes world in 2s). P12 = TWO-SHOT REFRAME (MS, Luma 28% / Byte 72%, 44% negative gap, Byte at exact eye-level). P13 = MIRROR: COMMITMENT BEAT (Lee Tanaka staging brief — directional ELEC_CYAN glow toward Luma, open body language, WARMTH arc mouth, cracked eye level not droopy). Arc: quiet night → curiosity → tension → threshold decision. 1136×630. Generator: `output/tools/LTG_TOOL_sb_pilot_cold_open_v003.py`. (Cycle 39 — Diego Vargas) |
| Living Room v002 | `/home/wipkat/team/output/backgrounds/environments/LTG_ENV_grandma_living_room_v002.png` | **Diamond-crystal secondary plant.** Small diamond-faceted crystal ornament on bookcase top shelf near CRT (center px 438,328, 18×22px). Four-facet crown+pavilion geometry. Warm amber catch-light. No GL palette values. At thumbnail: warm-gold decorative object. On rewatch: echoes Glitch Layer diamond geometry → Grandma Miri / digital Miri connection. QA: value range PASS (min=26,max=228), warm/cool sep=25.4 PASS. Single change over v001. Generator: `output/tools/LTG_TOOL_env_grandma_living_room_v002.py`. (Cycle 39 — Hana Okonkwo) |
...
| Proportion audit v003 | `/home/wipkat/team/output/tools/LTG_TOOL_proportion_audit_v003.py` | **Per-cycle runner.** `--cycle N` CLI flag, auto-updates report heading + output path to `proportion_audit_c{N}.md`. No more per-cycle wrapper scripts. C39 run: PASS=4, ASYM-WARN=2 (SF02 intentional sprint asymmetry), WARN=1 (SF01 v003 legacy/superseded), FAIL=0. Report: `output/production/proportion_audit_c39.md`. (Cycle 39 — Rin Yamamoto) |
| Fill Light Adapter v001 | `/home/wipkat/team/output/tools/LTG_TOOL_fill_light_adapter_v001.py` | **Resolution-aware fill light adapter.** Accepts fractional (0.0–1.0) or absolute pixel character positions. Auto-scales blur/gradient radii to canvas size. `FillLightAdapter` class + `FillLightConfig` dataclass + `make_glitch_storm_fill_configs()` SF02 3-char preset + `apply_fill_light()` convenience function. Tested: 720p + 1080p PASS. Supersedes inline algorithm in SF02 v008. (Cycle 39 — Rin Yamamoto) |
| Procedural Draw v1.6.0 | `/home/wipkat/team/output/tools/LTG_TOOL_procedural_draw_v001.py` | **C39 audit pass.** `get_char_bbox()` confirmed clean in SF02 v008 (uses geometry constants, not bbox for multi-char frames — correct) and SF03 v005 (no `add_rim_light()` calls — no risk). Docstring updated with multi-char frame warning: always pass `cx` from geometry constants, never call `get_char_bbox()` on a multi-character frame. (Cycle 39 — Rin Yamamoto) |
| Luma expression sheet v011 | `/home/wipkat/team/output/characters/main/LTG_CHAR_luma_expressions_v011.png` | **THE NOTICING right-eye lid fix + power balance + DOUBT VARIANT.** Top lid drops ~22% via BG-colored overdraw (focusing squint — upper lid closes, lower anchors). Forward chin-thrust (`cx_offset=int(HR*0.02)`) on THE NOTICING. DETERMINED forward hip lean (`body_tilt:-int(HR*0.08)`) + weight-shift stance. SLOT 7: THE NOTICING — DOUBT variant (right eye 88% aperture + brow kink, backward lean, muted violet border). Silhouette gate: DOUBT vs THE NOTICING well under 82% RPD target. 8 expressions. 1200×900. Generator: `output/tools/LTG_TOOL_luma_expression_sheet_v011.py`. (Cycle 38 — Maya Santos) |
| Cosmo expression sheet v007 | `/home/wipkat/team/output/characters/main/LTG_CHAR_cosmo_expression_sheet_v007.png` | **SKEPTICAL arm fix.** New `arm_mode="skeptical_crossed"`: arms folded inward at waist with hands crossing left-center — clearly outside torso silhouette. Notebook tucked left per spec. Resolves 3-cycle P2 arm-merge-with-body issue. S003 glasses_tilt compliance preserved (within 7° ±2°). 1182×1114. Generator: `output/tools/LTG_TOOL_cosmo_expression_sheet_v007.py`. (Cycle 38 — Maya Santos) |
| Byte expression sheet v006 | `/home/wipkat/team/output/characters/main/LTG_CHAR_byte_expression_sheet_v006.png` | **Silhouette differentiation pass.** ALARMED arm_x_scale 1.5→2.0 (max reach, full startle). RELUCTANT JOY: more asymmetry (left floats / right heavy). POWERED DOWN arm_x_scale 0.7→0.20 (limp/nearly no extension). RESIGNED arm_x_scale 0.50→0.25 (defeated, arms barely visible). Visual result: four expressions now clearly distinct at squint-test. 712×1280. Generator: `output/tools/LTG_TOOL_byte_expression_sheet_v006.py`. (Cycle 38 — Maya Santos) |
| SF01 Style Frame v006 | `/home/wipkat/team/output/color/style_frames/LTG_COLOR_styleframe_discovery_v006.png` | **Sight-line fix + visual power.** Head turned +18px toward CRT. Screen-side eye wider (wonder), away-side eye narrower (concentration). Pupils shifted toward Byte's screen position. Screen-side brow raised high, away-side brow inner-corner kink (doubting her own conclusion). Reaching arm (open palm, not pointing). 4 wild hair strands (kinetic energy). 12 hoodie pixels. QA: render_qa PASS (warm/cool PASS, value ceiling PASS, proportion audit PASS). Sight-line diagrammable by composition alone. 1280×720. Generator: `output/tools/LTG_TOOL_styleframe_discovery_v006.py`. (Cycle 38 — Rin Yamamoto) |
| render_qa v1.5.0 | `/home/wipkat/team/output/tools/LTG_TOOL_render_qa_v001.py` | REAL threshold corrected 20.0→12.0 (was wrong value; now matches `warmth_lint_v004` world_presets). SF01 (sep=17.9) now PASS. SF02 (sep=6.5) still WARN — REAL_STORM sub-type to be added C39. (Cycle 38 — Sam Kowalski) |
| World-type infer tool v001 | `/home/wipkat/team/output/tools/LTG_TOOL_world_type_infer_v001.py` | Infers world type from filename patterns for .png and .py files. Returns canonical warm/cool threshold. `batch_infer()`, `--threshold` CLI. Adds "luma_byte" → REAL pattern (SF04 fix). (Cycle 38 — Sam Kowalski) |
...
| CI suite C38 report | `/home/wipkat/team/output/production/ci_suite_c38_report.md` | C38 CI run. G002 false positive RESOLVED (LTG_TOOL_glitch_spec_lint_v001.py docstring matched by rx/ry regex — suppression entry added). Naming violations RESOLVED: LTG_CHAR_luma_motion_v001 + LTG_CHAR_byte_motion_v001 → LTG_TOOL_ canonical copies. LTG_SB_pilot_cold_open_v001 → LTG_TOOL_pilot_cold_open_v001 forwarding stub. (Cycle 38 — Kai Nakamura) |
