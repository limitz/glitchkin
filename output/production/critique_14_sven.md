...
**QA tools used:** `LTG_TOOL_render_qa_v001.py` (all 4 pitch PNGs), `LTG_TOOL_proportion_audit_v001.py`, source code audit of all 4 generators
...
5. **ALL FRAMES:** Run `LTG_TOOL_color_verify_v002.py --histogram` on SF03 and SF04 to diagnose the color fidelity FAIL before next critique cycle.
