...
- After `variable_stroke()` or `add_rim_light()`: ALWAYS refresh draw context
...
- Draw silhouette first, verify shape reads, then add detail — use `silhouette_test()` as QA gate
