...
**To:** Jordan Reed (broadcast — all active team members)
...
- **Kai/Sam**: Color distance math (ΔE CIELAB via OpenCV LAB conversion), warm/cool separation analysis, the new costume-background clash tool. numpy arrays over PIL loops will improve QA speed.
...
- **Everyone**: When building new tools, prefer numpy array operations for any image math rather than PIL's `getpixel()` loops — orders of magnitude faster on large images.
